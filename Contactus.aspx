  ...
  <tr>
          ...
          <tr>
            <td align="left">
              ...
              <table align="left" class="text">
                ...
                <td  width="140" valign="top" style="padding-top:5px; padding-left:7; padding-right:7px;">
                    <img src="images/21.jpg" width="134" height="413" style="float:left;" /></td>
            <td>
              ...
              <tr>
                <td class="head2">If you need to get in touch with us, we are just a phone or email 
              ...
              <tr>
                <td align="left"><table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    ...
                    <td valign="top" width="75%" class="text" align="left"><strong>
                        <a href="http://www.mapquest.com/directions/main.adp?src=maps&amp;1sb=revise&amp;2l=5Q%2fKINRQxeX63LoYZDyn%2fw%3d%3d&amp;2g=aM6tWcIXcFPUCxRWGQVBiA%3d%3d&amp;2v=ADDRESS&amp;2a=1039%20Sterling%20Rd&amp;2c=Herndon&amp;2s=VA&amp;2z=20170%2d3870&amp;2y=US&amp;2pn=&amp;2pl=" target="_blank" class="text">Gets MapQuest TM driving directions from your Office or Home?</a></strong><br />
                        <br /><br /><br />
                      </td>
                  </tr>
                  <tr>
                    <td height="17" colspan="2" align="left" class="data8">Office Timings:
                        <font color="navy" face="Arial" size="2"><span style="font-size: 10pt; font-family: Arial; padding-left:30px";>
                        9:00 am to 6:00 pm</span></font></td>
                  </tr>
                  <tr>
                    <td height="17" colspan="2" align="left" class="data8">Class Timings :<font color="navy"
                            face="Arial" size="2"><span style="font-size: 10pt; font-family: Arial;padding-left:30px">3:00 
                        pm to 8:00 pm</span></font><br /><br /></td>
                  </tr>
                  <tr>
                   <%-- <td height="17" style="width: 11px">&nbsp;</td>--%>
                    <td height="17" colspan="2" align="left" class="head1"><b>Training Location : </b></td>
                  </tr>
                </table>                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="data"><strong>1033 Sterling Road,  Ste#204</strong>,<br />
                    <strong>Herndon-VA-20170. USA.</strong>,<br />
                  <strong>Washington DC Metro Area.</strong></td></tr>
              </table>
              </td>
              ...
              <tr>
                ...
                <td class="data" style="height: 5px" align="left">
                    <strong>
                        <span >Voice &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;</span> 	703-574-3268 <br />
                        <span >Fax&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp;&nbsp;</span>    703-649-6458 <br />
                        <span >mail to&nbsp; :&nbsp;&nbsp;</span> <a href="mailto:learning@indusintl.net">learning@indusintl.net</a> <br />
                    </strong>
                </td>
              </tr>
              <tr>
                <td >
                  <strong > <span class="data"> Visit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;</span></strong>
                   <a href="http://www.indusintl.net" class="data6">http://www.indusintl.net</a><br />
                </td>
              </tr>

              <tr>
                <td align="left"><table align="left" border="0" cellpadding="2" cellspacing="2" width="95%">
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td><table align="center" border="0" cellpadding="2" cellspacing="2" 
                              ...
                              <tbody>
                                <tr>
                                  <td  class="data" align="right">Full Name *&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; </td>
                                  <td class="data">
                                   <asp:TextBox ID="txtName" MaxLength="50" runat="server" width="235px"></asp:TextBox>
                                ...
                                <tr>
                                  ...
                                  <td  class="data">  <asp:TextBox ID="tel" MaxLength="10" runat="server" width="235px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                  <td class="data">E-Mail *
                                  </td>
                                  <td  class="data" >
                                  <asp:TextBox ID="txtEmail" MaxLength="50" runat="server" width="235px"></asp:TextBox>
    ...
    <asp:RegularExpressionValidator ID="Emailexp" runat="server" ControlToValidate="txtEmail"
        Display="Dynamic" ErrorMessage="Invalid Email ID" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                        ...
                        <td class="data">
                        <asp:TextBox ID="address" MaxLength="50"  TextMode="MultiLine" Wrap="true" Columns="30" Rows="4" runat="server" width="235px"></asp:TextBox>
                        </td>
                      </tr>
                        ...
                        <td  class="data" >
                        <select name="country" class="dataas" id="country" runat="server">
                            <option value="" selected>Choose a Country</option>
                                ...
                                <tr>
                                  ...
                                  <td> <asp:TextBox ID="comments" TextMode="MultiLine" Wrap="true" Columns="30" Rows="6" runat="server" width="235px"></asp:TextBox></td>
