...
public partial class Schedules : System.Web.UI.Page
{
   ...
   fulldet = fulldet + "<tr> <td colspan='9' align='center' width='100%'><font color='#003399' size='3pt'  line-height:30px;><b>Course Schedule for Week Days</b></font> </td></tr>";
        fulldet = fulldet + "<tr><td align='center'valign='middle' class='lablelx' width='20%'><b>Course Name</b></td>";
        ...
        fulldet = fulldet + "<td align='center' valign='middle' class='lablelx' width='11%'><b>Class Timings</b></td>";
        fulldet = fulldet + "<td align='center' valign='middle' class='lablelx' width='10%'><b>Region</b></td>";
        fulldet = fulldet + "<td align='center' valign='middle' class='lablelx'width='9%'><b>Posted On</b></td>";
        ...
        if (!ds.Tables[0].Rows.Count.Equals(0))
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                fulldet = fulldet + "<tr><td align='center' class='lable1' valign='middle'>";
                fulldet = fulldet + ds.Tables[0].Rows[i]["Course"].ToString() + "</td><td align='center' class='lable1'valign='center'>";
                fulldet = fulldet + ds.Tables[0].Rows[i]["grade"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet = fulldet + ds.Tables[0].Rows[i]["C_duration"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet = fulldet + ds.Tables[0].Rows[i]["C_sdate"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet = fulldet + ds.Tables[0].Rows[i]["C_edate"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet = fulldet + ds.Tables[0].Rows[i]["C_timing"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet = fulldet + ds.Tables[0].Rows[i]["location"] + ", "
                    + ds.Tables[0].Rows[i]["country"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
        ...
        fulldet1 = fulldet1 + "<tr> <td colspan='9' align='center' width='100%'><font color='#003399' size='3pt'  line-height:30px;><b>Course Schedule for Week Ends</b></font> </td></tr>";
        fulldet1 = fulldet1 + "<tr><td align='center'valign='middle' class='lablelx' width='20%'><b>Course Name</b></td>";
        ...
        fulldet1 = fulldet1 + "<td align='center' valign='middle' class='lablelx' width='11%'><b>Class Timings</b></td>";
        fulldet1 = fulldet1 + "<td align='center' valign='middle' class='lablelx' width='10%'><b>Region</b></td>";
        fulldet1 = fulldet1 + "<td align='center' valign='middle' class='lablelx'width='9%'><b>Posted On</b></td>";
        ...
        if (!ds1.Tables[0].Rows.Count.Equals(0))
        {
            for (int i = 0; i < ds1.Tables[0].Rows.Count; i++)
            {
                ...
                fulldet1 = fulldet1 + "<tr><td align='center' class='lable1' valign='middle'>";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["Course"].ToString() + "</td><td align='center' class='lable1'valign='center'>";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["grade"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["C_duration"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["C_sdate"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["C_edate"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["C_timing"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet1 = fulldet1 + ds1.Tables[0].Rows[i]["location"] + ", "
                    + ds1.Tables[0].Rows[i]["country"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
        ...
        fulldet2 = fulldet2 + "<tr><td align='center'valign='middle' class='lablelx' width='20%'><b>Course Name</b></td>";
        ...
        if (!ds2.Tables[0].Rows.Count.Equals(0))
        {
            for (int i = 0; i < ds2.Tables[0].Rows.Count; i++)
            {
                ...
                fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["Course"].ToString() + "</td><td align='center' class='lable1'  valign='center'>";
                fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["grade"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["C_duration"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                //fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["ExamDate"].ToString() + "</td><td align='center' class='lable' valign='center'>";
                fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["C_sdate"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["C_edate"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet2 = fulldet2 + ds2.Tables[0].Rows[i]["C_timing"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
        ...
        fulldet3 = fulldet3 + "<tr><td align='center'valign='middle' class='lablelx' width='20%'><b>Course Name</b></td>";
        ...
        if (!ds3.Tables[0].Rows.Count.Equals(0))
        {
            for (int i = 0; i < ds3.Tables[0].Rows.Count; i++)
            {
                ...
                fulldet3 = fulldet3 + "<tr><td align='center' class='lable1' valign='middle' >";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["Course"].ToString() + "</td><td align='center' class='lable1'  valign='center'>";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["grade"].ToString() + "</td><td align='center' class='lable1' valign='center' >";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["C_duration"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                //fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["ExamDate"].ToString() + "</td><td align='center' class='lable' valign='center'>";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["C_sdate"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["C_edate"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["C_timing"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
                fulldet3 = fulldet3 + ds3.Tables[0].Rows[i]["location"] + ", " + ds3.Tables[0].Rows[i]["country"].ToString() + "</td><td align='center' class='lable1' valign='center'>";
