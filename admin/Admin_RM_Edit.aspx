<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_RM_Edit.aspx.cs" Inherits="Admin_RM_Edit" %>

<%@ Register Src="Usercontrols/TopMenu.ascx" TagName="TopMenu" TagPrefix="uc1" %>

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>: : Indus Learning : Admin : : </title>
  ...
  <table width="1180" cellpadding="0" cellspacing="0" bgcolor="#ffffff" align="center">
   ...
   <tr>
    ...
    <td colspan='2' align="center" valign="bottom" style="height: 30px">
          <br /><br />
      <font size='4pt' color="#660000"><b> Edit Menu Items (Right Menu)</b></font></td>
          </tr>
          <tr>
    ...
    <tr>
      <td colspan="2" class="lable" style="height: 26px">
          <div align="left"><br />
              ...
              &nbsp;
              <asp:Button ID="reset" runat="server" CssClass="labled" Height="22px" Text="Cancel" CausesValidation="false" OnClick="reset_Click1" /></div></td>
    </tr>
  </table>
