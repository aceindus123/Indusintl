<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Duration_Create.aspx.cs" Inherits="Admin_Duration_Create" %>
   ...
   <tr>
    ...
    <tr>
      ...
      <td style="width: 201px; height: 20px" class="lable16" align="right" valign="middle">
           Duration Type&nbsp; * &nbsp;&nbsp;:&nbsp;&nbsp;</td>
       <td style="width: 451px; height: 20px; margin-left: 120px;">
           <asp:TextBox ID="TextBox1" runat="server" CssClass="lable" Width="172px" BorderWidth='1'></asp:TextBox>            
