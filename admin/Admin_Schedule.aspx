<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Schedule.aspx.cs" Inherits="Admin_Schedule" %>
...
<head id="Head1" runat="server">
	...
	function alertedit()
{
alert("Course Schedule has been edited Successfully");
}
function alertdelete()
{
alert("Course Schedule has been deleted Successfully");
}
    </script>
...
<body id="body1" runat="server" topmargin="0" leftmargin="0" bgcolor="#ffffff">
   ...
   <tr>
    <td align="center" valign="top" width='100%'>
     ...
     <tr>
      <td id="tdcontent3" runat="server" align="center" valign="top" width="100%" class="lable"> 
      </td>
    </tr>
    ...
    <tr>
     ...
     <tr>
      <td id="tdcontent2" runat="server" align="center" valign="top" width="100%" class="lable"> 
      </td>
    </tr>
