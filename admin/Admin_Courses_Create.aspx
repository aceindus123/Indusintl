<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Courses_Create.aspx.cs" Inherits="Admin_Courses_Create" %>
...
<body id="body1" runat="server" topmargin="0" leftmargin="0" bgcolor="#ffffff">
   ...
   <tr>
    ...
    <td colspan='2' align="left" valign="bottom" style="height: 30px">
      ...
      <td style="width: 201px; height: 20px" class="lable16" align="right" valign="middle">
       ...
       <td style="width: 451px; height: 20px;">
           <asp:TextBox ID="categ" runat="server" CssClass="lable" Width="172px" BorderWidth='1' Height="25"></asp:TextBox>            
    ...
    <tr>
      <td colspan="2" class="lable9" style="height: 26px;padding-right:150px;">
          <div align="center">
