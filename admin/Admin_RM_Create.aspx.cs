...
public partial class Admin_RM_Create : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        string useremail = mitem.Text.ToString();
        ...
        //string[] myArr = useremail.Split(new Char[] { ' ', ',' });
            ...
            SqlCommand cmd = new SqlCommand("insert into ln_rightmenu (menu_item,menu_link,pdate) VALUES(@aemail,@aname,@postdate)", connection);
        ...
        //Response.Redirect("Admin_RM_Create.aspx?ret=ok");

       // Response.Redirect("Admin_RM_Create.aspx");

            string strscpt = "alert('Menu Item Posted sucessfully');location.replace('Admin_RightMenu.aspx');";
