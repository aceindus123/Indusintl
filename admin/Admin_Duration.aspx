<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Duration.aspx.cs" Inherits="Admin_Duration" %>
...
<script language="javascript" type="text/javascript">
	function alertedit()
{
alert("Course Duration has been edited Successfully");
}
function alertdelete()
{
alert("Course Duration has been deleted Successfully");
}
    </script>
