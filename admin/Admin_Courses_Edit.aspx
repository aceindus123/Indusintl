<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Courses_Edit.aspx.cs" Inherits="Admin_Courses_Edit" %>
   ...
   <tr>
    ...
    <td colspan='2' align="left" valign="bottom" style="height: 30px">
      ...
      <td style="width: 201px; height: 20px" class="lable16" align="right" valign="middle">
          Course Name &nbsp;*&nbsp; &nbsp; &nbsp;: &nbsp; &nbsp; &nbsp; </td>
       <td style="width: 451px; height: 20px;" align="left">
    ...
    <tr>
      <td colspan="2" class="lable9" style="height: 26px">
          <div align="left">
              ...
              &nbsp;
              <asp:Button ID="reset" runat="server" CssClass="labled" Height="22px" Text="Cancel" OnClick="reset_Click" /></div></td>
    </tr>
  </table>
