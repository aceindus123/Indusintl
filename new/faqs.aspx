          ...
          <tr>
            <td align="left">
              ...
              <table align="left" class="text">
                ...
                <td  valign="top" style="padding-top:5px; padding-left:7; padding-right:7px;"><img src="images/21.jpg" width="134" height="413" style="float:left;" /></td>
              <td class="text">
                    
                    
                     <table width="643" border="0" cellpadding="0" cellspacing="8" class="text">
                    <tr>
                      <td class="data8">Q1: What are the courses offered at Indus Learning Inc.?</td>
                    </tr>
                    <tr>
                      <td class="text">Ans: select the courses click on the tab courses<br />
                        Or<br />
                    ...
                    <tr>
                      <td class="data8">Q8: After the course is completed, will we be able to contact for further questions or assistance?</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="data8">Q9: Do we get any study material after enrolling for a course?</td>
                    </tr>
                    <tr>
                      <td class="data5">Ans: You would be getting study material for some eligible courses after enrollment and payment of fees.</td>
                    </tr>
                    <tr>
                      <td class="data8">Q10: Can we repeat the classes?</td>
                    </tr>
                    <tr>
