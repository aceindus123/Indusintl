...
function mmLoadMenus() {
  ...
  mm_menu_0401150035_0.addMenuItem("hhh");
   ...
   mm_menu_0401150035_0.menuBorderBgColor='#B4DFF1';
    ...
    mm_menu_0401170430_0_1.addMenuItem("Vocabulary","location='PageUnderConstruction.aspx'");
    ...
    mm_menu_0401170430_0_2.addMenuItem("Pre-Algebra","location='Math.aspx'");
    mm_menu_0401170430_0_2.addMenuItem("Algebra&nbsp;1","location='Math.aspx'");
    mm_menu_0401170430_0_2.addMenuItem("Algebra&nbsp;2","location='Math.aspx'");
    mm_menu_0401170430_0_2.addMenuItem("Geometry","location='Math.aspx'");
    mm_menu_0401170430_0_2.addMenuItem("Pre-Calculus","location='Math.aspx'");
    mm_menu_0401170430_0_2.addMenuItem("Calculus","location='Math.aspx'");
    mm_menu_0401170430_0_2.addMenuItem("Statistics","location='Math.aspx'");
    ...
    mm_menu_0401170430_0_7.addMenuItem("French","location='#'");
    ...
    mm_menu_0401170430_0_8.addMenuItem("HW&nbsp;Help-Middle(7th-9th)","location='Hwork.aspx'");
    mm_menu_0401170430_0_8.addMenuItem("HW&nbsp;Help-High(10th-12th)","location='Hwork.aspx'");
  ...
  mm_menu_0401170430_0.addMenuItem("FRENCH","location='PageUnderConstruction.aspx'");
  mm_menu_0401170430_0.addMenuItem("SOCIAL","location='PageUnderConstruction.aspx'");
  mm_menu_0401170430_0.addMenuItem("HISTORY","location='PageUnderConstruction.aspx'");
  mm_menu_0401170430_0.addMenuItem("HINDI","location='PageUnderConstruction.aspx'");
...
window.mm_menu_0405120830_0 = new Menu("root",150,22,"Arial",12,"#FFFFFF","#FFFFFF","#2391BF","#E08C06","left","middle",5,1,1000,-5,7,true,true,true,0,false,false);
  ...
  mm_menu_0405120830_0.addMenuItem("SCIENCE","location='PageUnderConstruction.aspx'");
  mm_menu_0405120830_0.addMenuItem("SOCIAL","location='PageUnderConstruction.aspx'");
  mm_menu_0405120830_0.addMenuItem("HISTORY","location='PageUnderConstruction.aspx'");
  ...
  mm_menu_0405120830_0.addMenuItem("SAT-I(Short&nbsp;Term)","location='PageUnderConstruction.aspx'");
  mm_menu_0405120830_0.addMenuItem("SAT-I(Long&nbsp;Term)","location='PageUnderConstruction.aspx'");
  mm_menu_0405120830_0.addMenuItem("SAT-II(short&nbsp;term)","location='PageUnderConstruction.aspx'");
  mm_menu_0405120830_0.addMenuItem("TJ&nbsp;PREP(6th-8th)","location='PageUnderConstruction.aspx'");
  ...
  mm_menu_0405121322_0.addMenuItem("ENGLISH","location='PageUnderConstruction.aspx'");
  ...
  mm_menu_0405123023_0.addMenuItem("Essay&nbsp;Writing","location='Sat1_CR.aspx'");
...
<td align="center" style="background-image:url(images/top_bg1.jpg); background-repeat:repeat-x "><table width="1000px" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" style="padding-top:4px "><img src="images/logo.jpg" /></td>
                  <td align="right"  style="padding-top:4px "><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="470" height="80">
                      <param name="movie" value="flash/topanimation.swf" />
                      <param name="wmode" value="transparent" />
                      <param name="quality" value="high" />
                      <embed src="flash/topanimation.swf" quality="high" wmode="transparent"  pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="470" height="80"></embed>
                    </object>
                  </td>
                </tr>
            </table></td>
          ...
          <tr>
            <td align="center" style="background-image:url(images/menubg.jpg); height:50px; background-repeat:repeat-x"><table width="1000" cellspacing="0" cellpadding="0" >
                <tr>
                  ...
                  <td><img src="images/menugap.jpg" width="3" height="50" /></td>
                  <td class="menu"><a href="http://www.igiit.net" target="_blank">Partners</a></td>
                  <td><img src="images/menugap.jpg" width="3" height="50" /></td>
          ...
          <tr>
             <td style=" border-bottom:1px solid #e9ecf1; border-top:1px solid #e9ecf1; background-image:url(flash/loading.gif); background-repeat:no-repeat"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="1000" height="200">
                <param name="movie" value="flash/bannerforInduslearning_1.swf" />
                <param name="quality" value="high" />
				<param name="WMode" value="Transparent" />
                <embed src="flash/bannerforInduslearning_1.swf" quality="high"  wmode="transparent" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="1000" height="200"></embed>
            </object></td>
  ...
  <tr>
    ...
    <td style=" border:1px solid #e9ecf1">
		<table cellpadding="0" cellspacing="0">
  <tr>
    <td style="padding:2px; "><img src="images/spring.gif" width="140" height="23" /></td>
    <td class="menu" width="570px"><marquee scrollamount="2" onmouseover="stop();" onmouseout="start();">ENGLISH - MATH - SCIENCE - SOCIAL - HISTORY - HINDI - SPANISH - FRENCH - VIRGINIA SOL - SAT - I(Short Term) - SAT - I(Long Term) - SAT - II(Short Term)</marquee></td>
  </tr>
</table>

	</td>
    <td width="4px"></td>
    <td align="right" style=" border:1px solid #e9ecf1"><img src="images/contactgif.gif" width="468" height="25" /></td>
	<td width="05px"></td>
