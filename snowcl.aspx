          ...
          <tr>
            <td align="left">
              ...
              <tr>             
                ...
                <td width="1000px" valign="top"><span class ="data8">Closings Due to Inclement Weather </span><br />
For classes held during weekday such as mathematics, writing Indus Intl center generally follows the class cancellation procedures of Fairfax County Public School (FCPS) and will not hold the class on the day when FCPS Closes its schools due to inclement weather.<br />
...
When there is an emergency other than inclement weather (such as power outage) that interrupts A Indus Intl center class schedule, we will post on our website any class cancellation announcement immediately. Parents and students are advised to visit Indus Intl web at<a href="http://www.indusintl.net" target="_blank" class="data8"> www.indusintl.net</a> or call <span class="data8">703-574-3268</span> for our announcement.<br />
<br />
...
Indus Intl web:<a href="http://www.indusintl.net" target="_blank" class="data8"> www.indusintl.net</a> Telephone: <span class="data8"> 703-574-3268 </span> <br />
<br />
<span class ="data8">Indus Intl Class Cancellation Policy</span></td>
                  </tr>
              </table>
